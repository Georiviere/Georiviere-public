import { JSONSchemaType } from 'json-schema-yup-transformer/dist/schema';
...
export type Observation = {
  ...
  label: string;
  description: string;
  json_schema_form: JSONSchemaType;
  stations: number[];
};
...
async function postObservation(props: PostObservationProps, id: string) {
